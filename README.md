...
📄 **[report.html](report.html) — the full reference:** how it works, how it's built, the security model, the retention guarantees, a verified example run against production, and a guide to **running your own relay**. Regenerated by every playground run, so its figures are measurements rather than claims.

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Version](https://img.shields.io/badge/version-1.0.7-green.svg)](https://wolffi.sh)
...
Each run verifies delivery byte for byte, audits the captured ciphertext, regenerates the committed [report.html](report.html), and leaves the actually-delivered files in `playground/out/` (gitignored). See [playground/README.md](playground/README.md) for the phase list and how to extend it.
